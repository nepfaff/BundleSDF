...
// Check if relaxed c++17 constexpr is supported.
...
template <typename Char>
inline basic_string_view<Char>
to_string_view(FMT_STRING_VIEW<Char> s)
{
  return s;
}
#endif
...
#define FMT_MAKE_VALUE_SAME(TAG, Type) \
  ...
  make_value(Char val) { return val; }
...
class basic_format_context : public internal::context_base<
