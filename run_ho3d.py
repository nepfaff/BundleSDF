...
code_dir_ho3d = os.path.dirname(os.path.realpath(__file__))
sys.path.append(f"{code_dir_ho3d}/BundleTrack/scripts")
...
def run_one_video(video_dir, out_dir):
    ...
    cfg_bundletrack = yaml.load(open(f"{code_dir_ho3d}/BundleTrack/config_ho3d.yml", "r"))
    ...
    cfg_nerf = yaml.load(open(f"{code_dir_ho3d}/config.yml", "r"))
